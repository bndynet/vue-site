...
export default defineConfig({
  ...
  // router: { mode: 'web' },
  // Public application-specific values are available from `useSiteConfig().config.custom` inside
  // components and `getSiteConfig().custom` in ordinary runtime modules.
