...
**`nav[].layout`** — optional page width mode: `'default'` keeps the standard centered reading width, `'wide'` uses a wider centered canvas, and `'full'` fills the available parent container. Use `'full'` for app-like pages such as dashboards.
